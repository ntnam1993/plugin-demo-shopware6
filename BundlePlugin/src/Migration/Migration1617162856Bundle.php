...
namespace BundlePlugin\Migration;

use Doctrine\DBAL\Connection;
use Shopware\Core\Framework\Migration\InheritanceUpdaterTrait;
use Shopware\Core\Framework\Migration\MigrationStep;

class Migration1617162856Bundle extends MigrationStep
{
    ...
    public function createBundleTable(Connection $connection): void
    {
    ...
    public function createBundleTranslationTable(Connection $connection): void
    {
        $connection->executeUpdate('
