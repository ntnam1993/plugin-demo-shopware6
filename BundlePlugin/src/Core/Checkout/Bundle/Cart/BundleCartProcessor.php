...
namespace BundlePlugin\Core\Checkout\Bundle\Cart;
...
use BundlePlugin\Core\Content\Bundle\BundleCollection;
...
class BundleCartProcessor implements CartProcessorInterface, CartDataCollectorInterface
{
    ...
    {
//        dd(count($original->getLineItems()->filterType(self::TYPE)) === 0);
...
//            if ($bundleLineItem->getQuantity() <= count($productLineItem->getChildren()->getElements()) - 1 ) {
